...
- **現在のプロトタイプ**: TypeScript (Node.js)
- **将来の本番環境**: 未定（パフォーマンス重視のコンポーネントにはRustまたはGoが候補）
- **注記**: 本仕様書中のJuliaコード例は説明目的です。動作するプロトタイプはTypeScriptで実装されています。
...
- **受取人の同意**: レイヤー1台帳に組み込み
- **TypeScriptプロトタイプ**: 豊富なエコシステムで高速な開発が可能；本番用言語は未定
- **人間中心の設計**: 2ボタン操作
- **将来対応**: AI・法制度との統合を考慮
